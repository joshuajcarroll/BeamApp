...
import { ChatPanel } from "@/components/ChatPanel"; // <-- add
...
function VideoCall() {
  ...
  return (
    <div className="flex h-screen">
      {/* Video area */}
      <div
        className={`flex-1 relative ${showChat ? "lg:w-[calc(100%-360px)]" : "w-full"}`}
      >
        <SpeakerLayout />
      ...
      {/* On small screens, you could render ChatPanel in a drawer or full-screen sheet */}
    </div>
  );
}
